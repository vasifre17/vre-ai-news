...
PUBLIC_LABELS = {
    "az": {
        ...
        "reader_reaction_title": "Bu xəbər sizdə hansı təəssürat yaratdı?",
        ...
        "domain_owner_name": "Vasif Cəbrayıllı",
    ...
    "en": {
        ...
        "reaction_surprising": "Surprising",
        "reaction_useful": "Useful",
        "like_label": "Like",
        "dislike_label": "Dislike",
        ...
        "domain_owner_name": "Vasif Jabrayilli",
...
PUBLIC_LABELS["ru"].update({
    ...
    "reader_reaction_title": "Какое впечатление произвела эта новость?",
    "reaction_interesting": "Интересно",
    "reaction_important": "Важно",
    "reaction_surprising": "Удивительно",
    ...
    "domain_owner_name": "Васиф Джабраилли",
...
PUBLIC_LABELS["tr"].update({
    ...
    "reader_reaction_title": "Bu haber sizde nasıl bir izlenim bıraktı?",
