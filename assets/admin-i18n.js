(() => {
  ...
  const translations = {
    az: {
      ...
      'AZ: Media Kitabxanası': 'AZ: Media Kitabxanası',
      'EN: Media Library': 'EN: Media Library',
      'Media Library Pro 2.0': 'Media Kitabxanası Pro 2.0',
      'Manage newsroom images with advanced search, responsive previews, reusable public URLs and safe deletion checks without changing existing upload storage.': 'Mövcud yükləmə saxlanmasını dəyişmədən inkişaf etmiş axtarış, responsiv önizləmələr, təkrar istifadə olunan public URL-lər və təhlükəsiz silmə yoxlamaları ilə xəbər otağı şəkillərini idarə edin.',
